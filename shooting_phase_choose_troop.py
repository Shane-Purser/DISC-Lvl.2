    ...
    if troop_location == 1:
      ...
      ##  if confirm == 1:
       ...
       # else:
        ...
        t_name_list.append([])                # makes a list in the weapon list then appends the new weapon to the new list.
        t_name_list[w].append(capital_weapon)
        troop_ws = eval(input("What is the troops weapon skill:"))                             # weapon strength armour pierce and damage
